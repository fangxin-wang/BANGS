...
#          python3 -W ignore main_node.py --multiview --random_pick --model $model --dataset $data --seed $seed --iter $iter_num --aug_drop 0.1  --top $top_node --split_by_num
      ...
      if (( top_node < candidate_num - 99)); then
          ...
          do
            ...
            do
               # IGP + calib ppr
                python3 -W ignore main_node.py --IGP_pick --model $model --dataset $data --seed $seed --iter $iter_num  --top $top_node --sample_num $sample_num --candidate_num $candidate_num --calib --PageRank --batchPPR $batchPPR  --k_union
...
#                python3 -W ignore main_node.py --IGP_pick --model $model --dataset $data --seed $seed --iter $iter_num  --top $top_node --sample_num $sample_num --candidate_num $candidate_num --calib  #--k_union
